...
if st.button("Submit"):
    ...
    if user_input:
        ...
        if recent_data:
            ...
            st.warning("The package name you entered, '"+user_input+"', is invalid. Please input a valid PyPI package name.")
    else:
        st.warning("The PyPI package name field is blank. Please provide a PyPI package name.")
